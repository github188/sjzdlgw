...
// 对象转换处理方法
// WKT转换为ArcGIS Point
function wkt2Point(wkt, spatialReference) {
	var _spatialReference = spatialReference || {"wkid":4326};
...
function wkt2Line(wkt, spatialReference) {
	var _spatialReference = spatialReference || {"wkid":4326};
...
function wkt2Polygon(wkt, spatialReference) {
	var _spatialReference = spatialReference || {"wkid":4326};
	var points = wktUtil.read(wkt);
	var json = {
		rings : points,
...
//ArcGIS 2点连线
function pp2line(wktp1,wktp2,spatialReference) {
	
	var _spatialReference = spatialReference || {"wkid":4326};
	
	var pt1 = wktUtil.read(wktp1);
	var pt2 = wktUtil.read(wktp2);
	
	var json = {
		"paths" : [[pt1[0],pt1[1]],[pt2[0],pt2[1]]],
		"spatialReference" : _spatialReference
	}
