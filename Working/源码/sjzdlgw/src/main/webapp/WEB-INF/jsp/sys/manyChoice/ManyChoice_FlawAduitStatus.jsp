...
<form id="pagerForm" method="post" action="${ctxPath}/ManyChoice/FlawAduitStatus">
    <input type="hidden" name="pageNum" value="${pageForm.pageNum}" />
    <input type="hidden" name="numPerPage" value="${pageForm.numPerPage}" />
</form>

<div class="pageHeader">
    <form rel="pagerForm" action="${ctxPath}/ManyChoice/FlawAduitStatus" method="post" onsubmit="return dwzSearch(this,'dialog');">
        <div class="searchBar">
...
<div class="pageContent">
    <table class="table" layoutH="118" targetType="dialog" width="100%">
        ...
        <c:forEach items="${pageForm.listDatas}" var="li">
                <td><input type="checkbox"class="checkboxCtrl" name="CablePath_Index_Area" value="${li.flawAduitStatusIDs}"/></td>
