...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li controlID="7602"><a class="add" href="${ctxPath}/Company/add/-1?type=${companyType}" target="dialog" rel="ManholeKindType_Index_01" title="添加" mask="true" minable="false" max="false" maxable="false" resizable="false" drawable="true" width="600" height="200"><span>添加</span></a></li>
            <li controlID="7602" class="line">line</li>
            <li controlID="7602"><a class="edit" href="${ctxPath}/Company/add/{sid_company}?type=${companyType}" target="dialog" rel="ManholeKindType_Index_02" warn="请选择一条记录" mask="true" minable="false" max="false" maxable="false" resizable="false" drawable="true" width="600" height="200"><span>修改</span></a></li>
            <li controlID="7602" class="line">line</li>
            <li controlID="7603"><a class="delete" href="${ctxPath}/Company/delete/{sid_company}?type=${companyType}" target="ajaxTodo" title="确定要删除吗?" warn="请选择一条记录"><span>删除</span></a></li>
            <li controlID="7603" class="line">line</li>
        </ul>
    </div>
