...
<div class="pageContent">
    <form method="post" action="${ctxPath}/ManholeLaborWell/add" class="pageForm required-validate" onsubmit="return validateCallback(this);">
        <input type="hidden" name="assetNum" value="${ManholeLaborWell.assetNum}"/>
        <input type="hidden" name="tunnel_AssetNum" value="${ManholeLaborWell.tunnel_AssetNum}"/>
        <div class="pageFormContent" layoutH="56">
            <p>
                <label>档案编号：</label>
                <input name="archivesCode"  type="text" size="30" value="${ManholeLaborWell.archivesCode}" readonly="true"/>
            </p>
            <p>
                <label>通道编号：</label>
                <input name="tunnelAssetCode"  type="text" size="30"  value="${ManholeLaborWell.tunnelAssetCode}" readonly="true"/>
            </p>
            <p>
                <label>工井编号：</label>
            ...
            <p>
                <label>经度：</label>
                <input name="longitude"  type="text" size="30"  value="${ManholeLaborWell.longitude}" readonly="true"/>
            </p>
            <p></p>
            <p>
                <label>纬度：</label>
                <input name="latitude" type="text" size="30"  value="${ManholeLaborWell.latitude}" readonly="true"/>
            </p>
            <dl class="nowrap">
                <dt>位置：</dt>
