...
<div class="pageHeader">
    <form rel="pagerForm" action="${ctxPath}/CablePath/index/Organization" method="post" onsubmit="return dwzSearch(this,'dialog');">
        <div class="searchBar">
            ...
            <div class="subBar">
                <ul>
                    ...
                    <li><div class="button"><div class="buttonContent"><button type="button" multLookup="CablePath_Index_Organization" warn="请选运检班组">选择</button></div></div></li>
                </ul>
            </div>
        </div>
    </form>
...
<div class="pageContent">
    <table class="table" layoutH="118" targetType="dialog" width="100%">
        ...
        <c:forEach items="${pageForm.listDatas}" var="li">
                <td><input type="checkbox"class="checkboxCtrl" name="CablePath_Index_Organization" value="${li.organizationNums}"/></td>
