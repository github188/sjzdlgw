...
<script>
    ...
    function dbclick() {
        $("#path_id_index2").click();
    }
</script>
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${ctxPath}/PathSection/2/index" method="post">
        <input type="hidden" name="idNum" value="${cablePathNum}" />
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            ...
            <%--<li class="line">line</li>--%>
                ...
                <li controlID="4012"><a class="add" href="${ctxPath}/PathSection/2/edit/add/-1?cablePathNum=${cablePathNum}" title="线路段添加" target="dialog" mask="true" minable="false" max="false" maxable="false" resizable="false" drawable="true" width="750" height="500"><span>添加</span></a></li>
                <li controlID="4012" class="line">line</li>
                </c:if>
                <li><a id="path_id_index2" style="display: none;" class="edit" href="${ctxPath}/PathSection/1/editview/modify/{sid_PathSection}?cablePathNum=${cablePathNum}" target="dialog" rel="ManholeKindType_Index_02" warn="请选择一条记录" mask="true" minable="false" max="false" maxable="false" resizable="false" drawable="true" width="800" height="600"></a></li>
                <li controlID="4012"><a class="edit" href="${ctxPath}/PathSection/2/edit/modify/{sid_PathSection}?cablePathNum=${cablePathNum}" target="dialog" rel="PathSection_Index_01" warn="请选择一条记录" mask="true" minable="false" max="false" maxable="false" resizable="false" drawable="true" width="750" height="500"><span>修改</span></a></li>
            <li controlID="4012" class="line">line</li>
            <li controlID="4013"><a class="delete" href="${ctxPath}/PathSection/2/delete/{sid_PathSection}" target="ajaxTodo" rel="PathSection_Index_03" title="确定要删除吗?" warn="请选择一条记录"><span>删除</span></a></li>
            <li controlID="4013" class="line">line</li>
                <li controlID="4015"><a class="edit" href="${ctxPath}/PathSection/2/charge/outage/{sid_PathSection}" target="dialog" rel="PathSection_Index_04" warn="请选择一条记录" mask="true" minable="false" max="false" maxable="false" resizable="false" drawable="true" width="600" height="300"><span>停运</span></a></li>
                <li controlID="4015" class="line">line</li>
                <li controlID="4016"><a class="edit" href="${ctxPath}/PathSection/2/charge/recover/{sid_PathSection}" target="dialog" rel="PathSection_Index_04" warn="请选择一条记录" mask="true" minable="false" max="false" maxable="false" resizable="false" drawable="true" width="600" height="300"><span>启用</span></a></li>
                <li controlID="4016" class="line">line</li>
                <li controlID="4017"><a class="edit" href="${ctxPath}/PathSection/2/charge/returned/{sid_PathSection}" target="dialog" rel="PathSection_Index_05" warn="请选择一条记录" mask="true" minable="false" max="false" maxable="false" resizable="false" drawable="true" width="600" height="300"><span>退运</span></a></li>
                <li controlID="4017" class="line">line</li>
            <%--<li><a class="edit" href="${ctxPath}/PathSection/chage/{sid_PathSection}" target="ajaxTodo" rel="PathSection_Index_06" warn="请选择一条记录" mask="true" minable="false" max="false" maxable="false" resizable="false" drawable="true" width="800" height="600"><span>切改</span></a></li>--%>
            <%--<li class="line">line</li>--%>
            <li controlID="4014"><a class="icon" href="${ctxPath}/CablePathSecetions/2/export/excel?idNum=${cablePathNum}" target="dwzExport" targetType="navTab" title="实要导出这些记录吗?"><span>查询导出</span></a></li>
        </ul>
    </div>
    <table class="table" width="120%" layoutH="87" asc="asc" desc="desc">
        ...
        <c:forEach items="${pageForm.listDatas}" var="li" varStatus="vs">
            <%--<tr target="sid_PathSection" rel="${li.pathSectionNum}">--%>
