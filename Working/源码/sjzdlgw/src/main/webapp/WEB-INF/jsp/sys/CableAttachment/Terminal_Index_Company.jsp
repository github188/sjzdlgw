...
<form id="pagerForm" method="post" action="${ctxPath}/CableAttachment/${pathType}/${attachmentTypeName}/index/Company">
    <input type="hidden" name="pageNum" value="${pageForm.pageNum}" />
    <input type="hidden" name="numPerPage" value="${pageForm.numPerPage}" />
</form>
<div class="pageHeader">
    <form rel="pagerForm" action="${ctxPath}/CableAttachment/${pathType}/${attachmentTypeName}/index/Company" method="post" onsubmit="return dwzSearch(this,'dialog');">
        <div class="searchBar">
