...
<form id="pagerForm" method="post" action="${ctxPath}/ManyChoice/Organization">
    <input type="hidden" name="pageNum" value="${pageForm.pageNum}" />
    <input type="hidden" name="numPerPage" value="${pageForm.numPerPage}" />
</form>

<div class="pageHeader">
    <form rel="pagerForm" action="${ctxPath}/ManyChoice/Organization" method="post" onsubmit="return dwzSearch(this,'dialog');">
        <div class="searchBar">
