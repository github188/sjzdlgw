...
<form id="pagerForm" method="post" action="${ctxPath}/CableAttachment/EarthBox/index/CableDeviceStyle">
    <input type="hidden" name="pageNum" value="${pageForm.pageNum}" />
    <input type="hidden" name="numPerPage" value="${pageForm.numPerPage}" />
</form>
<div class="pageHeader">
    <form rel="pagerForm" action="${ctxPath}/CableAttachment/EarthBox/index/CableDeviceStyle" method="post" onsubmit="return dwzSearch(this,'dialog');">
        <div class="searchBar">
