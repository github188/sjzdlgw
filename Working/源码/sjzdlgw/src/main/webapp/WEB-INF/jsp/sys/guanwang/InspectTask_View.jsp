...
<div class="pageContent">
    <form method="post" action="" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);">
        ...
        <div class="pageFormContent">
            <div style="border:1px solid #959595;margin-top: 9px;padding-top: 14px;padding-bottom:40px;width: 623px;margin-left:auto;margin-right:auto;height: 222px;">
                <table class="a-success-table" style="margin-left:auto;margin-right:auto;">
                    ...
                    <tr>
                        ...
                        <td>${InspectTask.taskName}</td>
                        <td class="w-label" class="w-label" class="w-label">两卡票号：</td>
                        <td>${InspectTask.workBillsCode}</td>
                    </tr>
                    <tr>
                        <td class="w-label" class="w-label">工作负责人：</td>
                        <td>${InspectTask.task_EmployeeName}</td>
                        <td class="w-label">开始时间：</td>
                        <td style="color:#FF0000;">${InspectTask.startDateTimeStr}</td>
                    </tr>
                    <tr>
                        <td class="w-label" class="w-label">工作班组：</td>
                        <td>${InspectTask.workUserList}</td>
                        <td class="w-label">完成时间：</td>
                        <td style="color:#FF0000;">${InspectTask.completeDateTimeStr}</td>
                    </tr>
                    <tr>
                        <td class="w-label">计划时间：</td>
                        <td style="color:#FF0000;">${InspectTask.planDateStr}</td>
                    </tr>
                </table>
            </div>
        </div>
