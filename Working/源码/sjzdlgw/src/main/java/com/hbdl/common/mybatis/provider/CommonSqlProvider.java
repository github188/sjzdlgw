package com.hbdl.common.mybatis.provider;
...
import com.hbdl.common.mybatis.EntityHelper;
...
public class CommonSqlProvider extends BaseProvider{
	...
	public String findEntityListByDataScope(final Map<String, Object> params){
		...
		return new SQL(){{
            ...
            com.hbdl.common.mybatis.EntityHelper.EntityTable entityTable = EntityHelper.getEntityTable(entityClass);
            SELECT(com.hbdl.common.mybatis.EntityHelper.getAllColumns(entityClass));
