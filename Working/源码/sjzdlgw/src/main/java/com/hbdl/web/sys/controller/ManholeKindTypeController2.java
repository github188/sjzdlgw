 ...
 */
@Controller
public class ManholeKindTypeController2 extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = "/ManholeKindType2/index")
     ...
     * @return
     */
    @RequestMapping(value = "/ManholeKindType2/index",method = RequestMethod.POST)
...
//        PageInfo<ManholeKindType> pageInfo=manholeKindTypeService.selectPage(pageForm.getPageNum(),pageForm.getNumPerPage(),manholeKindType ,new StringBuilder(pageForm.getOrderField()).append(" ").append(pageForm.getOrderDirection()).toString());
       ...
       if (manholeTypeList!=null){
        ...
        return getMessage(ControllerConstants.ManholeKindType1006);
    }
     ...
     * @return
     */
    @RequestMapping(value = "/ManholeKindType2/add/{sid_mhkt}",method = RequestMethod.GET)
    public String editeView(ModelMap modelMap, @PathVariable BigDecimal sid_mhkt){
        ...
        return getMessage(ControllerConstants.ManholeKindType1007);
    }
     ...
     * @return
     */
    @RequestMapping(value = "/ManholeKindType2/add",method = RequestMethod.POST)
     ...
     * @return
     */
    @RequestMapping(value = "/ManholeKindType2/delete/{sid_mhkt}",method = RequestMethod.POST)
    public String delete(ModelMap modelMap, @PathVariable BigDecimal sid_mhkt){
        if (sid_mhkt!=null && sid_mhkt.longValue()>0){
            ...
            logger.error(getMessage(ControllerConstants.SYS1007,ControllerConstants.ManholeKindType1006+sid_mhkt));
            modelMap.addAttribute(ControllerConstants.AJAXDONE_OBJECT, new AjaxDone(ControllerConstants.AJAXDON_ERROR, getMessage(ControllerConstants.SYS1007,ControllerConstants.ManholeKindType1008)));
            return getMessage(ControllerConstants.SYS1008);
        }
