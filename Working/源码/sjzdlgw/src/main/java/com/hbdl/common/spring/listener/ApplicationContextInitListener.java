package com.hbdl.common.spring.listener;
...
//	@Resource
//	private AResourceService sysResourceService;
...
//	private MaintainTaskDefinitionService maintainTaskDefinitionService;
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		if (null != parentContext) {
			...
			//读取全部资源
//			LinkedHashMap<String, AResources> AllResourceMap = sysResourceService.getAllResourcesMap();
